...
{{
  ...
  "nationality_type": "容疑者・被告の国籍。【重要】日本のメディアは外国人容疑者の国籍を必ず明記する慣習がある。そのため、タイトル・本文・RSS概要のいずれにも外国籍・外国語名の記載がなく、かつ住所が日本国内の場合は「日本」を選択すること。外国籍が明記されている場合のみ該当国を選択。住所も名前も全く不明な場合のみ「不明」。選択肢: {NATIONALITY_TYPES}",
